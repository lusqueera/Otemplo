...
/** `signingOut` cobre logout/exclusão em andamento: o AuthGate mostra a tela de transição. */
export type AuthStatus = 'loading' | 'signedOut' | 'signedIn' | 'signingOut';
...
export const useAuthStore = create<AuthState>((set) => ({
  ...
  markSigningOut: () => set({ status: 'signingOut' }),
}));
